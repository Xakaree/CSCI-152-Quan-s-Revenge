function CSelect(){
  ...
  this.Update = function(){
    ...
    if (input.keyPress(38)) // up
    {
          this.char1.color = (this.char1.color + 1)% this.versions;
    }
      else if (input.keyPress(40)) // down
    {
          this.char1.color = (this.char1.color -1)% this.versions;
    ...
    else if (input.keyPress(37)) { //left
      this.char1.color = 0;
    ...
    else if (input.keyPress(39)) { // right
          this.char1.color = 0;
          this.char1.character = (this.char1.character+1)% this.characters.length;
    }

    else if(input.keyPress(32)){ // space
      this.active = false;

      this.selection.push(this.characters[this.char1.character][this.char1.color]);
      this.selection.push(this.characters[this.char2.character][this.char2.color]);
